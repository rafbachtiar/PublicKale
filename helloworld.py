...
def clientBot(op):
    try:
        ...
        if op.type == 5:
            ...
            sendMention(op.param1, "Halo @!, elu ngeadd gua ya?? ??")
        ...
        if op.type == 13:
            ...
            if clientMid in op.param3:
                ...
                sendMention(op.param1, "Halo @!, numpang rusuh yaa")

        if op.type in [22, 24]:
            print ("[ 22 And 24 ] NOTIFIED INVITE INTO ROOM & NOTIFIED LEAVE ROOM")
            if settings["autoLeave"] == True:
                sendMention(op.param1, "Woi ngentod @!, ngapain invite gua")
                    ...
                    if msg.contentType == 0:
                        if text is None:
                            ...
                            if cmd == "help":
                                ...
                                start = time.time()
                                client.sendMessage(to, "Lagi Dihitung...")
                                elapsed_time = time.time() - start
                                client.sendMessage(to, "[ Speed ]\nKecepatannya {} detik".format(str(elapsed_time)))
                            elif cmd == "runtime":
                                timeNow = time.time()
                                runtime = timeNow - botStart
                                runtime = format_timespan(runtime)
                                client.sendMessage(to, "Bot berjalan jalan selama {}".format(str(runtime)))
                            elif cmd == "restart":
                                client.sendMessage(to, "Berhasil mengulang Bot")
                                restartBot()
# Pembatas Script #
                            elif cmd == "autoadd on":
                                ...
                                client.sendMessage(to, "auto leave nonaktif")
                            elif cmd == "autorespon on":
                                settings["autoRespon"] = True
                                client.sendMessage(to, "auto respon aktif")
                            elif cmd == "autorespon off":
                                settings["autoRespon"] = False
                                client.sendMessage(to, "auto respon nonaktif")
                                ...
                                client.sendMessage(to, "auto join by link aktif )
                            elif cmd == "autoJoinTicket off":
                                settings["autoJoin"] = False
                                client.sendMessage(to, "auto join by link nonaktif")
                                ...
                                client.sendMessage(to, "unsend message aktif")
                            elif cmd == "unsendchat off":
                                settings["unsendMessage"] = False
                                client.sendMessage(to, "unsend message nonaktif")
                            elif cmd == "status":
                                try:
                                    ret_ = "╔══[ Status ]"
...
# Pembatas Script #
                                ...
                                if receiver in read['readPoint']:
                                    ...
                                    read['ROM'][receiver] = {}
                                    client.sendMessage(receiver,"Lurking aktif")
                                else:
                                    try:
                                        del read['readPoint'][receiver]
                                        del read['readMember'][receiver]
                                ...
                                if receiver not in read['readPoint']:
                                    client.sendMessage(receiver,"Lurking nonaktif")
                                else:
                                    try:
                                        del read['readPoint'][receiver]
                                        del read['readMember'][receiver]
                                ...
                                if msg.to in read["readPoint"]:
                                    ...
                                    client.sendMessage(msg.to, "Lurking aja belum aktif")
                                ...
                                for target in targets:
                                    try:
                                        ...
                                        client.sendMessage(msg.to,"Target bertambah!!!")
                                        break
                                    except:
                                ...
                                for target in targets:
                                    try:
                                        ...
                                        client.sendMessage(msg.to,"Target musnah!!!")
                                        break
                                    except:
                                        client.sendMessage(msg.to,"Gagal memusnahkan target")
                                        break
                        ...
                        if "/ti/g/" in msg.text.lower():
                            if settings["autoJoinTicket"] == True:
                                ...
                                for ticket_id in n_links:
                                    ...
                                    client.sendMessage(to, "Udah masuk ke grup bro %s" % str(group.name))
                        if 'MENTION' in msg.contentMetadata.keys()!= None:
                            names = re.findall(r'@(\w+)', text)
                            mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                            mentionees = mention['MENTIONEES']
                            ...
                            for mention in mentionees:
                                if clientMid in mention["M"]:
                                    if settings["autoRespon"] == True:
                                        sendMention(sender, "Woi ngentod @!, ngapain tag gw?", [sender])
                                    break
            except Exception as error:
                logError(error)
                traceback.print_tb(error.__traceback__)
